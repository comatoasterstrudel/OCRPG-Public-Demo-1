...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("OCRPG", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("OCRPG", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "happycampers";
		app.meta["file"] = "OCRPG";
		app.meta["name"] = "OCRPG";
		app.meta["packageName"] = "com.happycamper.ocrpg";
		app.meta["version"] = "0.0.0";
