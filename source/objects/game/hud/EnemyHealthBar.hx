...
class EnemyHealthBar extends FlxTypedGroup<FlxSprite>
{
	...
	public function new(coolenemy:Enemy)
	{
		...
		enemyHealthBar = new FlxBar(0, 20, LEFT_TO_RIGHT, Std.int(enemyHealthBarOutline.width - 55), 48, enemyCharacter, 'hplerp', 0, enemyCharacter.maxhp);
	...
	{
		enemyHealthText.text = enemyCharacter.hp + ' / ' + enemyCharacter.maxhp;
