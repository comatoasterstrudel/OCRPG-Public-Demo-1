...
class FlxSoundTray extends Sprite
{
	...
	public var volumeSound:String = Paths.sound('volChange', 'global');
	...
	public function new()
	{
		...
		#else
		#end
		var dtf:TextFormat = new TextFormat(Paths.font('andy', 'global'), 10, 0xffffff);
	...
	public function update(MS:Float):Void
	{
		...
		SaveData.manageSaveData('volume', 'save');
	}
